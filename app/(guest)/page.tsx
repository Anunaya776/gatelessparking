  ...
  return (
    <main className="sm:container">
     ...
     <SearchComponent />
      ...
      <h3 className="text-2xl sm:text-4xl font-bold text-slate-88888 pt-16 pb-16 text-center uppercase tracking-wide">
        There is always a spot available.
      </h3>

      <section className="hidden lg:block pt-16 pb-32 relative">
      ...
      <section>
         <div className="pt-16 w-full absolute left-0 sm:bg-map bg-cover bg-no-repeat bg-center  bg-opacity-10 bg-blend-overlay">
              <Image alt="mobile screenshot" width={2000} height={800}
              src="/map-bg.png" />
            </div>
        <div className="pt-16 w-full absolute left-0 sm:bg-map bg-cover bg-no-repeat bg-center  bg-opacity-25 bg-blend-overlay">
